...
def run(cfg):
    ...
    print(f"US-China Trade War | Events: {summary['n_tariff_events']} | Escalations: {summary['n_escalation_events']} | Sharpe: {sharpe:.2f if sharpe else 'N/A'} | Written to {cfg.outdir}")
