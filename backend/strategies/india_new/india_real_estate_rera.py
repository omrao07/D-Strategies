...
def run(cfg):
    ...
    print(f"India RERA | Registrations YoY: {summary['latest_yoy_pct']:.1f}% | Signal: {summary['latest_signal']} | Sharpe: {f'{sharpe:.2f}' if sharpe else 'N/A'} | Written to {cfg.outdir}")
