...
def run(cfg):
    ...
    print(f"India Semicon | Announcements: {summary['total_fab_announcements']} | Pipeline: ${latest_pipeline:.1f}bn | Sharpe: {f'{sharpe:.2f}' if sharpe else 'N/A'} | Written to {cfg.outdir}")
