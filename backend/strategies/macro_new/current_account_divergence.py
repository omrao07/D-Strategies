...
def run(cfg):
    ...
    print(f"Current account | Countries: {summary['n_countries']} | Overweight signals: {summary['n_overweight']} | Sharpe: {sharpe:.2f if sharpe else 'N/A'} | Written to {cfg.outdir}")
