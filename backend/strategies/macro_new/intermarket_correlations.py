...
def run(cfg):
    ...
    print(f"Intermarket corr | Pairs: {summary['n_pairs_tracked']} | Stagflation risk days: {summary['stagflation_risk_days']} | Sharpe: {f'{sharpe:.2f}' if sharpe else 'N/A'} | Written to {cfg.outdir}")
