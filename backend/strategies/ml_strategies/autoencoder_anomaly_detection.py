...
def run(cfg):
    ...
    print(f"Autoencoder Anomaly | Events: {summary['total_anomaly_events']} | Rate: {summary['anomaly_rate_pct']:.1f}% | Sharpe: {f'{sharpe:.2f}' if sharpe else 'N/A'} | Written to {cfg.outdir}")
